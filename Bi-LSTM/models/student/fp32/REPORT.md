...
- Model: 9,857 parameters (1x24 bi-LSTM, pool `final_masked_mean`)
- Trained in 1.8s on `cpu` (1 member(s))

## What this run does and does not show

| Question | Answer from this run |
|---|---|
| Does the pipeline run end to end? | Yes: 2890 windows, reload difference 0.00e+00 |
| Better than carrying the last value forward? | RMSE skill 0.411 vs persistence |
| Better than seasonal climatology? | RMSE skill 0.289 |
| Better than a linear model on the same window? | RMSE skill -0.008 vs ridge |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| **Bi-LSTM** | 0.17242 | 0.13311 | 0.5490 | 0.7600 | 0.12750 | 0.719 | 0.330 | 0.531 | 0.548 |
...
|---:|---:|---:|---:|---:|
| 0 (kept) | 42 | 17 | 7 | 0.15642 |

## Provenance

- Command: `.venv/bin/dewsat distill --data data/synthetic_monthly.csv --config configs/student.json --teacher runs/teacher/best.pt --out runs/student_distilled`
...
- Checkpoint: `best.pt`, 46,909 bytes
